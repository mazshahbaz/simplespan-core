...
| AI Workflow Guide | [ai/ai-workflow-guide.md](ai/ai-workflow-guide.md) |
| Coding Standards | [1-governance/coding-implementation-standards.md](1-governance/coding-implementation-standards.md) |
| Semantic Versioning | [1-governance/adrs/ADR-003-semantic-versioning.md](1-governance/adrs/ADR-003-semantic-versioning.md) |
| Decision Records (ADRs) | [1-governance/adrs/](1-governance/adrs/) |
